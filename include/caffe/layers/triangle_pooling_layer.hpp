#ifndef CAFFE_TRIANGLE_POOLING_LAYER_HPP_
#define CAFFE_TRIANGLE_POOLING_LAYER_HPP_
...
class TrianglePoolingLayer : public Layer<Dtype> {
 public:
  explicit TrianglePoolingLayer(const LayerParameter& param)
    : Layer<Dtype>(param) {}
  ...
  virtual inline const char* type() const { return "TrianglePooling"; }
