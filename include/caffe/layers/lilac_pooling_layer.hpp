#ifndef CAFFE_Lilac_POOLING_LAYER_HPP_
#define CAFFE_Lilac_POOLING_LAYER_HPP_
 ...
 * R-FCN
 * Written by Jialin Wu :P
 */

template <typename Dtype>
class LilacPoolingLayer : public Layer<Dtype> {
 public:
  explicit LilacPoolingLayer(const LayerParameter& param)
    : Layer<Dtype>(param) {}
  ...
  virtual inline const char* type() const { return "LilacPooling"; }
