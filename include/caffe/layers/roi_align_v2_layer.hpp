#ifndef CAFFE_ROI_POOLING_V2_HPP_
#define CAFFE_ROI_POOLING_V2_HPP_
 ...
 *
 * @param param provides ROIAlignParameter roi_pooling_param,
 *        with ROIAlignLayer options:
...
class ROIAlignV2Layer : public Layer<Dtype> {
 public:
  explicit ROIAlignV2Layer(const LayerParameter& param)
      : Layer<Dtype>(param) {}
  ...
  virtual inline const char* type() const { return "ROIAlignV2"; }
 ...
 protected:
  ...
  Blob<Dtype> max_idx_x_;
  Blob<Dtype> max_idx_y_;
};
