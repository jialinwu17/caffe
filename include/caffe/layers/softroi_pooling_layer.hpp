#ifndef CAFFE_SOFTROI_POOLING_LAYER_HPP_
...
class SOFTROIPoolingLayer : public Layer<Dtype> {
 public:
  explicit SOFTROIPoolingLayer(const LayerParameter& param)
    : Layer<Dtype>(param) {}
  ...
  virtual inline const char* type() const { return "SOFTROIPoolingLayer"; }
