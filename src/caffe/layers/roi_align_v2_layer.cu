...
template <typename Dtype>
void ROIAlignV2Layer<Dtype>::Forward_gpu(const vector<Blob<Dtype>*>& bottom,
...
template <typename Dtype>
__global__ void ROIPoolBackward(const int nthreads, const Dtype* top_diff,const Dtype* argmax_data_x,const Dtype* argmax_data_y, const int num_rois, const Dtype spatial_scale,
...
template <typename Dtype>
void ROIAlignV2Layer<Dtype>::Backward_gpu(const vector<Blob<Dtype>*>& top,
...
INSTANTIATE_LAYER_GPU_FUNCS(ROIAlignV2Layer);
