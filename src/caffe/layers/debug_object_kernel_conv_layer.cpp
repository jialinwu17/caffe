...
void DebugObjectKernelConvolutionLayer<Dtype>::LayerSetUp(const vector<Blob<Dtype>*>& bottom,
...
template <typename Dtype>
void DebugObjectKernelConvolutionLayer<Dtype>::Reshape(const vector<Blob<Dtype>*>& bottom,
      const vector<Blob<Dtype>*>& top) {
  const int first_spatial_axis = channel_axis_ + 1;
...
template <typename Dtype>
void DebugObjectKernelConvolutionLayer<Dtype>::compute_output_shape() {
...
template <typename Dtype>
void DebugObjectKernelConvolutionLayer<Dtype>::Forward_cpu(const vector<Blob<Dtype>*>& bottom,
      const vector<Blob<Dtype>*>& top) {
  NOT_IMPLEMENTED;
}

template <typename Dtype>
void DebugObjectKernelConvolutionLayer<Dtype>::Backward_cpu(const vector<Blob<Dtype>*>& top,
...
#ifdef CPU_ONLY
STUB_GPU(DebugObjectKernelConvolutionLayer);
#endif

INSTANTIATE_CLASS(DebugObjectKernelConvolutionLayer);
REGISTER_LAYER_CLASS(DebugObjectKernelConvolution);
