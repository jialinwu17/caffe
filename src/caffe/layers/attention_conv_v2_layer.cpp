#include <vector>
#include "caffe/layers/attention_conv_v2_layer.hpp"
...
void AttentionConvolutionV2Layer<Dtype>::LayerSetUp(const vector<Blob<Dtype>*>& bottom,
...
template <typename Dtype>
void AttentionConvolutionV2Layer<Dtype>::Reshape(const vector<Blob<Dtype>*>& bottom,
      const vector<Blob<Dtype>*>& top) {
  const int first_spatial_axis = channel_axis_ + 1;
 ...
 // printf("kernel_dim_ : %d,output_shape_0: %d,output_shape_1: %d \n",kernel_dim_ * group_,output_shape_[0],output_shape_[1]);
  ...
  attention_joint_col_buffer_.Reshape(col_buffer_shape_);
...
template <typename Dtype>
void AttentionConvolutionV2Layer<Dtype>::compute_output_shape() {
...
template <typename Dtype>
void AttentionConvolutionV2Layer<Dtype>::Forward_cpu(const vector<Blob<Dtype>*>& bottom,
      const vector<Blob<Dtype>*>& top) {
...
template <typename Dtype>
void AttentionConvolutionV2Layer<Dtype>::Backward_cpu(const vector<Blob<Dtype>*>& top,
...
template <typename Dtype>
void AttentionConvolutionV2Layer<Dtype>::forward_gpu_bias(Dtype* output,
    const Dtype* bias) {
...
template <typename Dtype>
void AttentionConvolutionV2Layer<Dtype>::forward_cpu_bias(Dtype* output,
    const Dtype* bias) {
...
template <typename Dtype>
void AttentionConvolutionV2Layer<Dtype>::backward_gpu_bias(Dtype* bias,
    const Dtype* input) {
  caffe_gpu_gemv<Dtype>(CblasNoTrans, num_output_, out_spatial_dim_, 1.,
      input, bias_multiplier_.gpu_data(), 1., bias);
}
template <typename Dtype>
void AttentionConvolutionV2Layer<Dtype>::backward_cpu_bias(Dtype* bias,
    const Dtype* input) {
...
#ifdef CPU_ONLY
STUB_GPU(AttentionConvolutionV2Layer);
#endif

INSTANTIATE_CLASS(AttentionConvolutionV2Layer);
REGISTER_LAYER_CLASS(AttentionConvolutionV2);
