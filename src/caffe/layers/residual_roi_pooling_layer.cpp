...
namespace caffe {
  ...
  void ResidualROIPoolingLayer<Dtype>::LayerSetUp(const vector<Blob<Dtype>*>& bottom,
  ...
  template <typename Dtype>
  void ResidualROIPoolingLayer<Dtype>::Reshape(const vector<Blob<Dtype>*>& bottom,
    const vector<Blob<Dtype>*>& top) {
    N_ = bottom[0]->shape(0);
  ...
  template <typename Dtype>
  void ResidualROIPoolingLayer<Dtype>::Forward_cpu(const vector<Blob<Dtype>*>& bottom,
    const vector<Blob<Dtype>*>& top) {
    NOT_IMPLEMENTED;
  }

  template <typename Dtype>
  void ResidualROIPoolingLayer<Dtype>::Backward_cpu(const vector<Blob<Dtype>*>& top,
...
//#endif
  ...
  INSTANTIATE_CLASS(ResidualROIPoolingLayer);
  REGISTER_LAYER_CLASS(ResidualROIPooling);
