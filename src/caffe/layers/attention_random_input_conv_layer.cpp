...
void AttentionRandomInputConvolutionLayer<Dtype>::LayerSetUp(const vector<Blob<Dtype>*>& bottom,
...
template <typename Dtype>
void AttentionRandomInputConvolutionLayer<Dtype>::Reshape(const vector<Blob<Dtype>*>& bottom,
      const vector<Blob<Dtype>*>& top) {
  ConvolutionParameter conv_param = this->layer_param_.convolution_param();
  const int first_spatial_axis = channel_axis_ + 1;
...
template <typename Dtype>
void AttentionRandomInputConvolutionLayer<Dtype>::compute_output_shape() {
...
template <typename Dtype>
void AttentionRandomInputConvolutionLayer<Dtype>::Forward_cpu(const vector<Blob<Dtype>*>& bottom,
      const vector<Blob<Dtype>*>& top) {
...
template <typename Dtype>
void AttentionRandomInputConvolutionLayer<Dtype>::Backward_cpu(const vector<Blob<Dtype>*>& top,
...
template <typename Dtype>
void AttentionRandomInputConvolutionLayer<Dtype>::forward_gpu_bias(Dtype* output,
    const Dtype* bias) {
...
template <typename Dtype>
void AttentionRandomInputConvolutionLayer<Dtype>::forward_cpu_bias(Dtype* output,
    const Dtype* bias) {
...
template <typename Dtype>
void AttentionRandomInputConvolutionLayer<Dtype>::backward_gpu_bias(Dtype* bias,
    const Dtype* input) {
  caffe_gpu_gemv<Dtype>(CblasNoTrans, num_output_, out_spatial_dim_, 1.,
      input, bias_multiplier_.gpu_data(), 1., bias);
}
template <typename Dtype>
void AttentionRandomInputConvolutionLayer<Dtype>::backward_cpu_bias(Dtype* bias,
    const Dtype* input) {
...
#ifdef CPU_ONLY
STUB_GPU(AttentionRandomInputConvolutionLayer);
#endif

INSTANTIATE_CLASS(AttentionRandomInputConvolutionLayer);
REGISTER_LAYER_CLASS(AttentionRandomInputConvolution);
